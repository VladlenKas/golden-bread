...
public class CompanyConfiguration : IEntityTypeConfiguration<Company>
{
    public void Configure(EntityTypeBuilder<Company> entity)
    {
        ...
        entity.Property(e => e.Inn).HasColumnName("inn").HasMaxLength(10).IsRequired();
        entity.Property(e => e.Ogrn).HasColumnName("ogrn").HasMaxLength(13).IsRequired();
        entity.Property(e => e.Phone).HasColumnName("phone").HasMaxLength(11);
