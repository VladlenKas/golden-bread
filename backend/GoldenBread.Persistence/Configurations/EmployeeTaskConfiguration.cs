...
public class EmployeeTaskConfiguration : IEntityTypeConfiguration<EmployeeTask>
{
    ...
    {   
        ...
        builder.Property(e => e.AssignedQuantity).HasColumnName("assigned_quantity");
        ...
        builder.HasOne(d => d.Employee).WithMany(p => p.EmployeeTasks)
            .HasForeignKey(d => d.EmployeeId)
            .OnDelete(DeleteBehavior.ClientSetNull)
            .HasConstraintName("fk_employee_tasks_employee_id");

        builder.HasOne(d => d.OrderItem).WithMany(p => p.EmployeeTasks)
