...
\restrict MWquFK75GFQeJ0wsNAjScqIawZ0Da8twXqdpJ3FkHKWNIjgVpCRNwLcZmbL3QUZ

-- Dumped from database version 17.6
-- Dumped by pg_dump version 17.6

-- Started on 2026-02-17 10:27:57
...
--
-- TOC entry 927 (class 1247 OID 17144)
...
--
-- TOC entry 253 (class 1259 OID 35526)
...
CREATE VIEW public.users_view AS
 SELECT su.user_id,
   ...
   FROM (public.users su
     JOIN public.accounts a ON ((su.account_id = a.account_id)));


ALTER VIEW public.users_view OWNER TO postgres;

--
-- TOC entry 4825 (class 2604 OID 35482)
...
--
-- TOC entry 4821 (class 2604 OID 17422)
...
--
-- TOC entry 4829 (class 2604 OID 35510)
...
--
-- TOC entry 4822 (class 2604 OID 17442)
...
--
-- TOC entry 4819 (class 2604 OID 17095)
...
--
-- TOC entry 4810 (class 2604 OID 16948)
...
--
-- TOC entry 4808 (class 2604 OID 16932)
...
--
-- TOC entry 4820 (class 2604 OID 17402)
...
--
-- TOC entry 4815 (class 2604 OID 17012)
...
--
-- TOC entry 4817 (class 2604 OID 17031)
...
--
-- TOC entry 4824 (class 2604 OID 17465)
...
--
-- TOC entry 4813 (class 2604 OID 16977)
...
--
-- TOC entry 4811 (class 2604 OID 16961)
...
--
-- TOC entry 4814 (class 2604 OID 16993)
...
--
-- TOC entry 4806 (class 2604 OID 16922)
...
--
-- TOC entry 4828 (class 2604 OID 35496)
...
--
-- TOC entry 5093 (class 0 OID 35479)
-- Dependencies: 248
-- Data for Name: accounts; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.accounts (account_id, email, password_hash, account_type, verification_status, session, session_expires_at, is_active) FROM stdin;
16	asdf	asdf	user	pending	\N	\N	0
17	fff	fff	user	approved	\N	\N	1
19	vlad@gmail.com	$2a$11$Rt1QkMz/r7QCqEFzi8oF9OCGDHn3ZZG2WP53GVRmYHDX/pv9tNSqW	company	pending	\N	\N	1
20	vlada@gmail.com	$2a$11$7CSjSaipq0Xe/Q4IwZ0tLuG3pHt9y24eJbQ.3mt2WQmUtwlWJG77.	company	pending	2a610b58-bef8-4000-aa22-52c635403e54@2026-01-29T03:47:22.9490343Z	2026-02-05 08:47:22.950119+05	1
21	adfas@afd.re	$2a$11$xHxEyLw9QSq4dR.coJdIrOQCcWLs6JllEutEjB6UwNvT7.zzfS5e.	company	pending	1b11277a-48a3-4ca7-a958-7745589b0411@2026-01-29T03:52:02.1261123Z	2026-02-05 08:52:02.12612+05	1
22	aaa@gmail.com	$2a$11$eptuAz/j8macxALQjWmH2O3k3lCL0KdUzqda0Aeo5h5Zk6DKBdC7u	company	pending	9285bffa-8cb5-4ebc-9047-e46a3bd59d90@2026-01-29T04:01:51.5296422Z	2026-02-05 09:01:51.52965+05	1
23	adfas@FDSA.RU	$2a$11$yaq4XNv5W/UN.U/jaISkTe5bH59tdLLIs0BZy4O7a6./2uM/TKiD.	company	pending	1ef9d02b-a51b-45a9-9292-8602d6c60afd@2026-01-29T04:26:49.0933499Z	2026-02-05 09:26:49.094528+05	1
24	adfas@sdfgsd.rt	$2a$11$9JNcfdkf8qi./TaX.G46oe3Vk79D5KR/bUJ3Sp.x4sMT1S./4qGwu	company	pending	a8053436-a87b-4509-94de-99a76d4ca361@2026-01-29T04:31:11.7163860Z	2026-02-05 09:31:11.716615+05	1
25	vlad@gmail.coq	$2a$11$LzG8Fk68K5QMjz7yHfgA.uiy1VmlTS3hxzueqeptgAEUblvdr8Itq	company	pending	f7c81dbf-64ae-4e82-ae92-c9f79f4ac773@2026-01-30T20:30:53.7770831Z	2026-02-07 01:30:53.777118+05	1
26	goldenbread@gmail.com	$2a$11$00/MpdNQvF6alBLjtOzsqe5YHIVIgD4m755xZLo5QkgqqO1U1B7ge	company	pending	ea1ec350-f32a-4330-a9b8-fa2d2c766ebc@2026-01-30T22:52:30.3770937Z	2026-02-07 03:52:30.377134+05	1
28	fasf@asfa.re	$2a$11$DdZ0eHjzbVgS221wg6B0R.wjotYD00b16SH7krDwXC0haGzVEig/G	company	pending	tiny-bear-494	2026-02-09 06:16:27.197078+05	1
29	asdf@gmail.com	$2a$11$0jqH60apwX7QgA44TXCly.OT.bMXZFYIzOTF7aEmwoh/J21/2rTLG	company	pending	fluffy-cat-233	2026-02-11 00:25:55.699158+05	1
32	asdfasdf@gmail.com	$2a$11$Ji083gNaqTaogIKVxrU8W.L1ZWcL4nFCgMDJqAUu/9wejbiV0pEdS	company	pending	cozy-owl-130	2026-02-11 21:40:32.283678+05	1
33	asdfasdasdf@gmail.com	$2a$11$6/AT26wCko/qRye4OxDoBOoKU3700vn/RjutODUnkgs447uM.D4V.	company	pending	cute-dog-330	2026-02-11 21:45:11.171613+05	1
34	asdfasdasdsf@gmail.com	$2a$11$fv0zZa0Sex1d.q6xHFdtH.u8HZNoNQuqW3xdUrWxewBg1uaGkjgEW	company	pending	soft-owl-200	2026-02-11 21:45:36.955872+05	1
35	asdfasadasdsf@gmail.com	$2a$11$hgEHcncXmzFfnjakXlGeCOJ5uGrnwzQesZ9.KqEzxu5lwH3U6YaN.	company	pending	soft-owl-777	2026-02-11 21:48:50.327157+05	1
36	asdfasaddasdsf@gmail.com	$2a$11$t6mjRKf2Qow5qoesCSGXAeyN8H4DQnRVZUSeGnBNi.OTv5OKj9Yke	company	pending	cute-dog-882	2026-02-11 21:49:02.569738+05	1
37	asdaddasdsf@gmail.com	$2a$11$wzYfaGhaD.zmIwem7vl9p.jwjFC4FJZoQYOZjj7paKE1ihaB9Yozm	company	pending	fluffy-bunny-967	2026-02-11 22:15:42.808389+05	1
38	asdaddsdsf@gmail.com	$2a$11$UIqaxqEIvOq0XG9gZTtm7uXiQDWGbkW9UvOtSnDWfE5xpIR/W2sPq	company	pending	tiny-fox-770	2026-02-11 22:16:03.115485+05	1
39	asdf@gmail.co	$2a$11$04S9UNlaoEAcaWYRKJntPu/2iyvq/MNlTXctsm.IBgEwlOnxlNPH6	company	pending	cute-cat-401	2026-02-11 23:04:14.190969+05	1
40	asdfasdasdff@gmail.com	$2a$11$r4vFOuLhnirZICN7RrW9peon77t29WwaqD6GNY3jPwddhnL97Aex2	company	pending	aa59366497d4433c88ae3232a9f0eec7	2026-02-17 03:16:43.098618+05	1
18	aaa	$2a$11$LZjN5vfJOhpdB1NcgPNCUu.Ko2EDoVpYrXRLdm3b45M/jLOZ20O1O	user	approved	227dfc9557834009858cf13f128e071c	2026-02-17 07:43:57.151264+05	1
\.


--
-- TOC entry 5087 (class 0 OID 17419)
-- Dependencies: 242
-- Data for Name: cart_items; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cart_items (cart_item_id, batch_id, quantity, account_id) FROM stdin;
\.


--
-- TOC entry 5097 (class 0 OID 35507)
-- Dependencies: 252
-- Data for Name: companies; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.companies (company_id, account_id, name, inn, ogrn, phone, address) FROM stdin;
2	20	fsdfg	1234567812	1212121212122	\N	\N
...
--
-- TOC entry 5089 (class 0 OID 17439)
-- Dependencies: 244
...
--
-- TOC entry 5063 (class 0 OID 16904)
-- Dependencies: 218
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.employees (employee_id, firstname, lastname, patronymic, birthday, is_delete) FROM stdin;
\.


--
-- TOC entry 5083 (class 0 OID 17092)
-- Dependencies: 238
-- Data for Name: favourites; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.favourites (favourite_id, product_id, account_id) FROM stdin;
\.


--
-- TOC entry 5071 (class 0 OID 16945)
-- Dependencies: 226
...
--
-- TOC entry 5069 (class 0 OID 16929)
-- Dependencies: 224
...
--
-- TOC entry 5085 (class 0 OID 17399)
-- Dependencies: 240
...
--
-- TOC entry 5079 (class 0 OID 17009)
-- Dependencies: 234
-- Data for Name: order_tariffs; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.order_tariffs (order_tariff_id, name, description, markup_percent, free_employees_percent, is_delete) FROM stdin;
1	Стандартный	Обычный тариф без наценок	0.00	0.00	0
\.


--
-- TOC entry 5081 (class 0 OID 17028)
-- Dependencies: 236
-- Data for Name: orders; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.orders (order_id, tariff_id, status, start_date, end_date, created_at, account_id) FROM stdin;
...
--
-- TOC entry 5091 (class 0 OID 17462)
-- Dependencies: 246
...
--
-- TOC entry 5065 (class 0 OID 16912)
-- Dependencies: 220
-- Data for Name: product_categories; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.product_categories (product_category_id, name, is_delete, color, icon, image) FROM stdin;
...
--
-- TOC entry 5075 (class 0 OID 16974)
-- Dependencies: 230
...
--
-- TOC entry 5073 (class 0 OID 16958)
-- Dependencies: 228
-- Data for Name: products; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.products (product_id, category_id, name, description, cost_price, sale_price, markup_percent, weight, production_time, is_delete) FROM stdin;
...
--
-- TOC entry 5077 (class 0 OID 16990)
-- Dependencies: 232
...
--
-- TOC entry 5067 (class 0 OID 16919)
-- Dependencies: 222
-- Data for Name: suppliers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.suppliers (supplier_id, name, email, phone, address, is_delete) FROM stdin;
1	ООО "ПродИнгредиент"	info@prodingredient.ru	79171234567	г. Уфа, ул. Складская, 15	0
\.


--
-- TOC entry 5095 (class 0 OID 35493)
-- Dependencies: 250
...
SELECT pg_catalog.setval('public.accounts_account_id_seq', 40, true);
...
SELECT pg_catalog.setval('public.companies_company_id_seq', 22, true);
...
--
-- TOC entry 4882 (class 2606 OID 35489)
...
--
-- TOC entry 4870 (class 2606 OID 17425)
...
--
-- TOC entry 4888 (class 2606 OID 35554)
...
--
-- TOC entry 4890 (class 2606 OID 35552)
...
--
-- TOC entry 4892 (class 2606 OID 35518)
...
--
-- TOC entry 4894 (class 2606 OID 35514)
...
--
-- TOC entry 4874 (class 2606 OID 17447)
...
--
-- TOC entry 4834 (class 2606 OID 16910)
...
--
-- TOC entry 4862 (class 2606 OID 17098)
...
--
-- TOC entry 4841 (class 2606 OID 16937)
...
--
-- TOC entry 4868 (class 2606 OID 17405)
...
--
-- TOC entry 4856 (class 2606 OID 17016)
...
--
-- TOC entry 4860 (class 2606 OID 17033)
...
--
-- TOC entry 4879 (class 2606 OID 17468)
...
--
-- TOC entry 4850 (class 2606 OID 16982)
...
--
-- TOC entry 4836 (class 2606 OID 16917)
...
--
-- TOC entry 4854 (class 2606 OID 16995)
...
--
-- TOC entry 4884 (class 2606 OID 35498)
...
--
-- TOC entry 4896 (class 2606 OID 35520)
...
--
-- TOC entry 4886 (class 2606 OID 35500)
...
--
-- TOC entry 4880 (class 1259 OID 35549)
-- Name: accounts_email_active_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX accounts_email_active_unique ON public.accounts USING btree (email) WHERE (is_active <> 0);


--
-- TOC entry 4871 (class 1259 OID 35535)
-- Name: fk_cart_items_account_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fk_cart_items_account_id_idx ON public.cart_items USING btree (account_id);


--
-- TOC entry 4872 (class 1259 OID 17437)
...
--
-- TOC entry 4875 (class 1259 OID 17458)
...
--
-- TOC entry 4876 (class 1259 OID 17459)
...
--
-- TOC entry 4863 (class 1259 OID 35541)
-- Name: fk_favourites_account_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fk_favourites_account_id_idx ON public.favourites USING btree (account_id);


--
-- TOC entry 4864 (class 1259 OID 17110)
...
--
-- TOC entry 4842 (class 1259 OID 16956)
...
--
-- TOC entry 4839 (class 1259 OID 16943)
...
--
-- TOC entry 4865 (class 1259 OID 17416)
...
--
-- TOC entry 4866 (class 1259 OID 17417)
...
--
-- TOC entry 4857 (class 1259 OID 35547)
-- Name: fk_orders_account_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fk_orders_account_id_idx ON public.orders USING btree (account_id);


--
-- TOC entry 4858 (class 1259 OID 17050)
...
--
-- TOC entry 4877 (class 1259 OID 17474)
...
--
-- TOC entry 4848 (class 1259 OID 16988)
...
--
-- TOC entry 4845 (class 1259 OID 16972)
...
--
-- TOC entry 4851 (class 1259 OID 17007)
...
--
-- TOC entry 4852 (class 1259 OID 17006)
...
--
-- TOC entry 4915 (class 2606 OID 35521)
...
--
-- TOC entry 4909 (class 2606 OID 35530)
-- Name: cart_items fk_cart_items_account_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cart_items
    ADD CONSTRAINT fk_cart_items_account_id FOREIGN KEY (account_id) REFERENCES public.accounts(account_id);


--
-- TOC entry 4910 (class 2606 OID 17475)
...
--
-- TOC entry 4911 (class 2606 OID 17448)
...
--
-- TOC entry 4905 (class 2606 OID 35536)
-- Name: favourites fk_favourites_account_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.favourites
    ADD CONSTRAINT fk_favourites_account_id FOREIGN KEY (account_id) REFERENCES public.accounts(account_id);


--
-- TOC entry 4906 (class 2606 OID 17104)
...
--
-- TOC entry 4897 (class 2606 OID 16938)
...
--
-- TOC entry 4907 (class 2606 OID 17406)
...
--
-- TOC entry 4908 (class 2606 OID 17480)
...
--
-- TOC entry 4903 (class 2606 OID 35542)
-- Name: orders fk_orders_account_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT fk_orders_account_id FOREIGN KEY (account_id) REFERENCES public.accounts(account_id);


--
-- TOC entry 4904 (class 2606 OID 17039)
...
--
-- TOC entry 4913 (class 2606 OID 17469)
...
--
-- TOC entry 4900 (class 2606 OID 16983)
...
--
-- TOC entry 4901 (class 2606 OID 17001)
...
--
-- TOC entry 4902 (class 2606 OID 16996)
...
--
-- TOC entry 4914 (class 2606 OID 35501)
...
-- Completed on 2026-02-17 10:27:58

--
-- PostgreSQL database dump complete
--

\unrestrict MWquFK75GFQeJ0wsNAjScqIawZ0Da8twXqdpJ3FkHKWNIjgVpCRNwLcZmbL3QUZ
