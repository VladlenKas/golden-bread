...
public class IngredientReservationServiceTests
{
    ...
    public async Task CheckAsync_SufficientIngredients_ReturnsTrue()
    {
        ...
        _batchRepositoryMock.Setup(b => b.GetAvailableForIngredientAsync(1, It.IsAny<CancellationToken>()))
            .ReturnsAsync(flourBatches);
        _batchRepositoryMock.Setup(b => b.GetAvailableForIngredientAsync(2, It.IsAny<CancellationToken>()))
